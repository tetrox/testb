  ...
  computed: {
    ...
    logoimg() {
      if (this.$store.state.game == 'GG') {
        return { 'background-image': 'url(img/WR_Brackets_WINNERS_GG.jpg)' };
      }
      return { 'background-image': 'url(img/WR_Brackets_WINNERS_TK.jpg)' };
    },
  },
  watch: {
...
.lines
	...
	height: $screen-height
	position: absolute
	background-image: url(img/WR_Brackets_WINNERS.png)
